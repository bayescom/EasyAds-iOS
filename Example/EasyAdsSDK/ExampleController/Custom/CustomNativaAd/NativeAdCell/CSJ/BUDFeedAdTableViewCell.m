...
- (void)buildupView {
    ...
    self.separatorLine.backgroundColor = [UIColor colorWithRed:0.16 green:0.17 blue:0.21 alpha:1.00];
    ...
    self.adDescriptionLabel.textColor = [UIColor colorWithRed:0.16 green:0.17 blue:0.21 alpha:1.00];
...
- (UIButton *)customBtn {
    if (!_customBtn) {
        ...
        [_customBtn setTitle:@"CustomClick" forState:UIControlStateNormal];
        [_customBtn setTitleColor:[UIColor colorWithRed:0.29 green:0.59 blue:1.00 alpha:1.00] forState:UIControlStateNormal];
...
- (void)refreshUIWithModel:(BUNativeAd *_Nonnull)model {
    ...
    NSAttributedString *attributedText = [CellBuilder titleAttributeText:model.data.AdTitle];
    ...
    self.adDescriptionLabel.attributedText = [CellBuilder subtitleAttributeText:model.data.AdDescription];
}
...
- (void)buildupView {
    ...
    self.bgView.backgroundColor = [UIColor colorWithRed:0.87 green:0.87 blue:0.87 alpha:1.00];
...
- (UIButton *)creativeButton
{
    if (!_creativeButton) {
        ...
        [_creativeButton setTitle:@"ClickDownload" forState:UIControlStateNormal];
