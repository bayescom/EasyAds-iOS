...
- (void)buildupView {
    ...
    _separatorLine.backgroundColor = [UIColor colorWithRed:0.16 green:0.17 blue:0.21 alpha:1.00];
...
-(void)refreshUIWithModel:(BUDFeedNormalModel *)model {
    self.model = model;
    _titleLabel.attributedText = [CellBuilder titleAttributeText:model.title];
    _sourceLable.attributedText = [CellBuilder subtitleAttributeText:model.source];
